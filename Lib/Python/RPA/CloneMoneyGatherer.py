...
z_money_gatherer = 'z:\\MoneyGatherer\\Dev9er'
...
def wait_until_find_mark(png_file):
	...
	:return:
	'''
	image_dir = 'z:\\_StartUp\\ARB\\RPA\\_Image'
	while True:
...
def clone_z_stockdata():
	...
	wait_until_find_mark('SourceTree_GitHub_MoneyGatherer.png')	# 30_MoneyGatherer 찾기
	print(pag.position())	# (933, 531)	# 30_MoneyGatherer 위치
	pag.move(1033, 21)	   	# (1966, 552)	# Clone 클릭
	pag.click()
	pag.sleep(3)
	pag.click(757, 410)	# 탐색 클릭
	wait_until_find_mark('SourceTree_RamDrive.png')	# RamDriver 클릭
	wait_until_find_mark('SourceTree_Z_MoneyGatherer.png')	# Z:\SetUp 클릭
...
if __name__ == '__main__':
	if not os.path.exists(z_money_gatherer):
		clone_z_stockdata()
