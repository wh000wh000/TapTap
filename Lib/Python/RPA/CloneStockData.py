...
def clone_z_stockdata():
	...
	wait_until_find_mark('SourceTree_GitHub_StockData.png')	# 00_SetUp 찾기
	# print(pag.position())	# (914, 698)	# 00_SetUp 위치
	pag.move(1055, 22)	   	# (1969, 720)	# Clone 클릭
	pag.click()
	pag.sleep(3)
	pag.click(757, 410)	# 탐색 클릭
	wait_until_find_mark('SourceTree_RamDrive.png')	# RamDriver 클릭
	wait_until_find_mark('SourceTree_Z_StockData.png')	# Z:\SetUp 클릭
...
if __name__ == '__main__':
	if not os.path.exists(z_stockdata):
		clone_z_stockdata()
